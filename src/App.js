      ...
      <header className="App-header">
        ...
        <div className="headerItems" style={{width: '68%', color: 'black'}}>
          <div className="jumbotron" style={jumboTron}>
            ...
            <div style={alertText} class="alert alert-primary" role="alert">
            ...
            <div style={alertText} class="alert alert-success" role="alert">
            ...
            <div style={alertText} class="alert alert-warning" role="alert">
